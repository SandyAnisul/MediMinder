...
export const hi: Dictionary = {
  ...
  help: "कमांड:\n/today — आज की दवा अनुसूची देखें\n/help — यह संदेश दिखाएं",
  notLinked: "यह चैट अभी किसी मरीज़ से नहीं जुड़ी है। कृपया एडमिन से अपना इनवाइट लिंक मांगें।",
  invalidLinkCode: "यह इनवाइट लिंक अमान्य है या पहले ही उपयोग हो चुका है। कृपया एडमिन से नया लिंक मांगें।",
};
